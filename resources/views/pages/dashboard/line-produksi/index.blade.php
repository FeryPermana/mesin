        ...
        <div class="card-body">
            <div class="my-5">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="{{ route('line-produksi.create') }}"
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @forelse ($lineproduksi as $l)
                            <tr>
                                <td>{{ increment($lineproduksi, $loop) }}</td>
                                <td>{{ $l->name }}</td>
                                <td>
                                    <a href="{{ route('line-produksi.edit', $l->id) }}"
                                        class="btn btn-warning btn-sm"><i class="ti ti-pencil"></i> Edit</a>

                                    <button class="btn btn-danger btn-sm delete-data"
                                        data-url="{{ route('line-produksi.destroy', $l->id) }}"
                                        data-id="{{ $l->id }}">
            ...
            <div class="d-flex justify-content-end">
                {{ $lineproduksi->withQueryString()->links() }}
            </div>
