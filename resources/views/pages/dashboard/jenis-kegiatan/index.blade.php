            ...
            <div class="my-5">
                <div class="row">
                    ...
                    <div class="col-md-6 text-end">
                        <a href="{{ route('jenis-kegiatan.create') }}" class="btn btn-primary">Tambah</a>
                    </div>
                </div>
            </div>
            <form>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $j->standart }}</td>
                            <td>
                                <a href="{{ route('jenis-kegiatan.edit', $j->id) }}" class="btn btn-warning btn-sm"><i class="ti ti-pencil"></i> Edit</a>

                                <button class="btn btn-danger btn-sm delete-data" data-url="{{ route('jenis-kegiatan.destroy', $j->id) }}" data-id="{{ $j->id }}">
