            ...
            <div class="my-5">
                <div class="row">
                    ...
                    <div class="col-6 text-end">
                        <a href="{{ route('mesin.create') }}" class="btn btn-primary">Tambah</a>
                    </div>
                </div>
            </div>
            <form>
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('mesin.edit', $m->id) }}" class="btn btn-warning btn-sm"><i class="ti ti-pencil"></i></a>

                                <button class="btn btn-danger btn-sm delete-data" data-url="{{ route('mesin.destroy', $m->id) }}" data-id="{{ $m->id }}">
